        ...
        <div class="row">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h3>Service List</h3>
                    <div class="mx-auto">
                        <a href="{{route('admin.service.create')}}"><button class="btn btn-primary btn-sm mx-auto">Add Service</button></a>
                    </div>
                            ...
                            @foreach ($service as $key => $data)
                                <tr>
                                    ...
                                    <td>  
                                        ...
                                        @endif</td>
                                    <td>
                                        <a class="mx-2" href="{{route('admin.service.edit',$data->id)}}"><i class="fas fa-edit"></i></a>
                                    ...
                                    <div class="modal-dialog modal-md modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('admin.service.delete', $data->id) }}" method="POST">
                                                    @csrf
