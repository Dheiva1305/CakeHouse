        ...
        <div class="row">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h3>Gallery List</h3>
                    <div class="mx-auto">
                        <a href="{{route('admin.home_slider.create')}}"><button class="btn btn-primary btn-sm mx-auto">Add Gallery</button></a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach ($home_slider as $key => $data)
                                <tr>
                                    ...
                                    <td>
                                        <a class="mx-2" href="{{route('admin.home_slider.edit',$data->id)}}"><i class="fas fa-edit"></i></a>
                                    ...
                                    <div class="modal-dialog modal-md modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('admin.home_slider.delete', $data->id) }}" method="POST">
                                                    @csrf
