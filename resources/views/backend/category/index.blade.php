        ...
        <div class="row">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h3>Category List</h3>
                    <div class="mx-auto">
                        <a href="{{route('admin.category.create')}}"><button class="btn btn-primary btn-sm mx-auto">Add Category</button></a>
                    </div>
                            ...
                            @foreach ($category as $key => $data)
                                <tr>
                                    ...
                                    <td>  
                                        ...
                                        @endif</td>
                                    <td>
                                        <a class="mx-2" href="{{route('admin.category.edit',$data->id)}}"><i class="fas fa-edit"></i></a>
